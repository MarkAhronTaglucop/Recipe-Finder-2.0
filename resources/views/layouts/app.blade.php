        ...
        <ul class="navbar-nav align-items-center">
          ...
          @auth
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="background: var(--primary-color); border: 1px solid var(--border-color);">
                <li>
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-md-4">
          ...
          <li>
             <a href="https://www.facebook.com/kurtchintaaaaaaa" target="_blank" class="text-decoration-none text-light opacity-75">
              Kurt Reserva
             </a>
          </li>
          <li>
             <a href="https://www.facebook.com/markahron.taglucop01" target="_blank" class="text-decoration-none text-light opacity-75">
              Mark Ahron Taglucop
             </a>
          </li>
          <li>
             <a href="https://www.facebook.com/profile.php?id=61570025041214" target="_blank" class="text-decoration-none text-light opacity-75">
              Marc Bashley Ybiernas
             </a>
          </li>
          <li>
             <a href="https://www.facebook.com/angel.sabrido" target="_blank" class="text-decoration-none text-light opacity-75">
              Lawrence Sabrido
             </a>
          </li>
          <li>
             <a href="https://www.facebook.com/louisrafael11" target="_blank" class="text-decoration-none text-light opacity-75">
